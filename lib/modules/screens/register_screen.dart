...
import 'package:payment/modules/screens/toggle_screen.dart';
...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PaymentCubit()..getFistToken(),
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocConsumer<PaymentCubit, PaymentStates>(
            ...
            if (state is SuccessRequestTokenState) {
                        ...
                        : DefaultButton(
                            ...
                            function: () {
                              if (formKey.currentState!.validate()) {
                                context.read<PaymentCubit>().getOrderId(
